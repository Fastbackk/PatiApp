                                ...
                                db.collection("users")
                                        ...
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                Toast.makeText(BiyografiEkle.this, "Profil fotoğrafı başarıyla güncellendi", Toast.LENGTH_SHORT).show();
                                                Intent intent=new Intent(BiyografiEkle.this, MainActivity.class);
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(BiyografiEkle.this, "Profil fotoğrafı güncellenirken bir hata oluştu: " + e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            } else {
